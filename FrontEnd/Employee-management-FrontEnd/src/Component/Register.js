...
function Register(){
    ...
    var register=()=>{
        fetch("http://localhost:5201/api/User/action/Register_User",{
            "method":"POST",
            headers:{
                "accept":"text/plain",
    ...
    const newLocal = "http://www.w3.org/1999/xlink";
    return (
        <div>
<div className="container">
            <div className="left">
                <form className="form">
                    ...
                    <div className="input-block">
                        <input type="text"  required className="input form-control" onChange={(event)=>{
                    ...
                    <div className="input-block">
                        ...
                        <label for="pwd" className="form-control"id="pass">Password</label>
                    </div>
                    <div className="input-block">
                        <input type="date" required className="input form-control"  onChange={(event)=>{
                    ...
                    <div className="input-block">
                        <input type="text" required className="input form-control"  onChange={(event)=>{
                            setEmployee({...employee,"passport":event.target.value})
                        }} />
                        <label className="form-control">Passport</label>
                    </div>
                    <div className="input-block">
                        <input type="text" required className="input form-control"  onChange={(event)=>{
                            setEmployee({...employee,"drivingLicenseNumber":event.target.value})
                        }} />
                        <label className="form-control">Driving License Number</label>
                    </div>
                    <div className="input-block">
                        <input type="text" required className="input form-control"  onChange={(event)=>{
                            setEmployee({...employee,"managerId":event.target.value})
                        }} />
                        <label className="form-control">Manager Id</label>
                    </div>
                        </div>
                    </div>               
            ...
            <div className="right">
                <div className="img"><svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 731.67004 550.61784" xmlnsXlink={newLocal}>
