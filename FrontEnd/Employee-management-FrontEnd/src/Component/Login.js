...
function Login(){
    ...
    var login=()=>{
        console.log(user);
        fetch("http://localhost:5201/api/User/action/Login_User",{
            "method":"POST",
            headers:{
                "accept":"text/plain",
...
<div className="container">
            <div className="left-login">
                <form className="form login-form">
                    <div class="input-block login-head">
                        <h2 className="form-head">Employee Management System</h2>
                    </div>
                    <div className="input-block">
                        <input type="number"  required className="input form-control" onChange={(event,e)=>{
                            setLoginUser({...user,"userId":event.target.value});
                        }} /> 
                        <label className="form-control" >UserId</label>


                    </div>
                    <div className="input-block">
                        <input type="password" required className="input form-control"  onChange={(event)=>{
                            setLoginUser({...user,"password":event.target.value})
                        }} />
                    ...
                    <div className="input-block">
                       ...
                       <Link to="/"><button onClick={login} className="login-button">Login</button></Link>        
                    </div>
                </form>
            </div>
            <div className="right">
